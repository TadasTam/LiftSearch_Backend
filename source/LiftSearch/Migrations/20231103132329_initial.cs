        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    cancelledCountDriver = table.Column<int>(type: "integer", nullable: false),
                    registeredDriverDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    lastTripDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    driverBio = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cancelledCountTraveler = table.Column<int>(type: "integer", nullable: false),
                    lastTripDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    travelerBio = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    startCity = table.Column<string>(type: "text", nullable: false),
                    endCity = table.Column<string>(type: "text", nullable: false),
                    startAdress = table.Column<string>(type: "text", nullable: true),
                    endAdress = table.Column<string>(type: "text", nullable: true),
